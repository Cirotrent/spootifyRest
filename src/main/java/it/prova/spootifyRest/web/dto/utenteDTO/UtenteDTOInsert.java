...
public class UtenteDTOInsert {
	...
	private List<RuoloDTO> ruoli =new ArrayList<>(0);
	@JsonIgnoreProperties(value= {"utente"})
	...
	public static UtenteDTOInsert buildUtenteDTOFromModel(Utente source, boolean eagerRuoli,boolean eagerSessione,boolean eagerPlaylist,boolean eagerRiproduzione) {
		UtenteDTOInsert result = new UtenteDTOInsert();
	...
	public static Utente buildUtenteModelFromDTO(UtenteDTOInsert source, boolean eagerRuolo,boolean eagerSessione,boolean eagerPlaylist,boolean eagerRiproduzione) {
	...
	public static List<UtenteDTOInsert> buildListFromModelList(List<Utente> input){
		
		List<UtenteDTOInsert> result= new ArrayList<UtenteDTOInsert>();
		for(Utente utenteItem: input) {
			UtenteDTOInsert utenteDTOtemp= UtenteDTOInsert.buildUtenteDTOFromModel(utenteItem, false, false, false, false);
